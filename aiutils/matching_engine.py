...
# os.environ["CREDENTIALS"] = "/home/user/iconnect/key.json"
...
class MatchingEngine(VectorStore):
    ...
    def __init__(
        ...
        credentials: Credentials ="/home/user/iconnect/key.json",
    ):
        """Vertex Matching Engine implementation of the vector store.
    ...
    def get_matches(
        ...
        header = {"Authorization": "Bearer " + self.get_gcs_token()}
    ...
    def from_components(
        ...
        credentials_path: Optional[str] = "/home/user/iconnect/key.json",
        ...
        # credentials = cls._create_credentials_from_file("/home/user/iconnect/key.json")
    ...
    #     with open('/home/user/iconnect/key.json', 'r') as f:
    ...
    #         json_key['auth_uri'],
    #         json_key['token_uri'],
    #         json_key['auth_provider_x509_cert_url'],
    #         json_key['client_x509_cert_url'],
    #     )
